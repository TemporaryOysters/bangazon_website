...
from .views import customer_view, product_detail_view, product_view, home_view, product_category_view
...
urlpatterns += [
    ...
    url(r'^producttype/', product_detail_view.get_product_detail, name='producttype'),
